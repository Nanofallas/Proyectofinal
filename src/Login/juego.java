...
public class juego extends javax.swing.JFrame {
    ...
    private void btnjugarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnjugarActionPerformed
        ...
        String usuario = jtxtUsuario.getText();
         ...
         char[] pass = jFpass.getPassword();
         
        
        if (jtxtUsuario.getText().equals(usuario) && jFpass.getPassword().equals(pass)){

            JOptionPane.showMessageDialog(null, "Has ingresado correctamente ", "Bienvenidos al Sistema ", JOptionPane.INFORMATION_MESSAGE);
            
        } else {
            JOptionPane.showMessageDialog(null, "Acceso Incorrecto ", "Intentelo de nuevo ", JOptionPane.ERROR_MESSAGE);
